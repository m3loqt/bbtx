      ...
      <div className="relative mx-auto max-w-[90rem]">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[0.85fr_1.15fr] lg:gap-10">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-medium leading-snug tracking-normal text-[#222222] sm:text-4xl lg:text-[2.5rem]">
            ...
            <div className="mt-8 divide-y divide-black/[0.08] border-t border-black/[0.08] sm:mt-10">
              {ADVANTAGE_ROWS.map((row) => (
                ...
                >
                  <h3 className="flex items-center gap-2.5 text-lg font-semibold tracking-normal text-[#222222] sm:text-xl">
